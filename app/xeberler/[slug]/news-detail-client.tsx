...
function mergeNews(adminNews: NewsArticle[], locale: 'en' | 'az', translateNewsArticle: (article: NewsArticle, locale: 'en' | 'az') => NewsArticle) {
...
function PremiumNewsPage({ article, locale }: { article: NewsArticle; locale: 'en' | 'az' }) {
  ...
  const featureItems =
    locale === 'az'
      ? [
          { icon: BrainCircuit, title: cmsText("xeberler/[slug]/news-detail-client.001"), description: cmsText("xeberler/[slug]/news-detail-client.002") },
          { icon: Settings, title: cmsText("xeberler/[slug]/news-detail-client.003"), description: cmsText("xeberler/[slug]/news-detail-client.004") },
          { icon: ChartNoAxesCombined, title: cmsText("xeberler/[slug]/news-detail-client.005"), description: cmsText("xeberler/[slug]/news-detail-client.006") },
          { icon: Users2, title: cmsText("xeberler/[slug]/news-detail-client.007"), description: cmsText("xeberler/[slug]/news-detail-client.008") },
        ]
      : [
          { icon: BrainCircuit, title: cmsText("xeberler/[slug]/news-detail-client.009"), description: cmsText("xeberler/[slug]/news-detail-client.010") },
          { icon: Settings, title: cmsText("xeberler/[slug]/news-detail-client.011"), description: cmsText("xeberler/[slug]/news-detail-client.012") },
          { icon: ChartNoAxesCombined, title: cmsText("xeberler/[slug]/news-detail-client.013"), description: cmsText("xeberler/[slug]/news-detail-client.014") },
          { icon: Users2, title: cmsText("xeberler/[slug]/news-detail-client.015"), description: cmsText("xeberler/[slug]/news-detail-client.016") },
        ]
  const premiumCopy =
    locale === 'az'
      ? {
          subtitle:
            cmsText("xeberler/[slug]/news-detail-client.017"),
          bodyOne:
            cmsText("xeberler/[slug]/news-detail-client.018"),
          bodyTwo:
            cmsText("xeberler/[slug]/news-detail-client.019"),
          quote:
            cmsText("xeberler/[slug]/news-detail-client.020"),
          heroAlt: cmsText("xeberler/[slug]/news-detail-client.021"),
          portraitAlt: cmsText("xeberler/[slug]/news-detail-client.022"),
        }
      : {
          subtitle:
            cmsText("xeberler/[slug]/news-detail-client.023"),
          bodyOne:
            cmsText("xeberler/[slug]/news-detail-client.024"),
          bodyTwo:
            cmsText("xeberler/[slug]/news-detail-client.025"),
          quote:
            cmsText("xeberler/[slug]/news-detail-client.026"),
          heroAlt: cmsText("xeberler/[slug]/news-detail-client.027"),
          portraitAlt: cmsText("xeberler/[slug]/news-detail-client.028"),
        }
  return (
      ...
      <section className="relative overflow-hidden px-4 pb-10 pt-28 sm:px-6 sm:pt-32 md:pt-36 lg:px-8 lg:pb-16">
        ...
        <div className="mx-auto w-full max-w-[1440px]">
          <div className="mb-8 flex flex-wrap items-center gap-3 text-[13px] text-[#7b818b]">
            <Link href={cmsText("xeberler/[slug]/news-detail-client.029")} className="transition-colors hover:text-[#070b16]">
              {locale === 'az' ? cmsText("xeberler/[slug]/news-detail-client.030") : cmsText("xeberler/[slug]/news-detail-client.031")}
            </Link>
            <ChevronRight className="h-3.5 w-3.5" />
            <Link href={cmsText("xeberler/[slug]/news-detail-client.032")} className="transition-colors hover:text-[#070b16]">
              {locale === 'az' ? cmsText("xeberler/[slug]/news-detail-client.033") : cmsText("xeberler/[slug]/news-detail-client.034")}
            </Link>
            <ChevronRight className="h-3.5 w-3.5" />
            <span className="text-[#6b7280]">
              {locale === 'az'
                ? cmsText("xeberler/[slug]/news-detail-client.035")
                : cmsText("xeberler/[slug]/news-detail-client.036")}
            </span>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,47%)_minmax(0,53%)] lg:items-start lg:gap-14">
            <div className="order-2 flex flex-col justify-center pt-2 sm:pt-4 lg:order-1 lg:pt-14">
              <span className="mb-4 inline-flex text-[12px] font-semibold uppercase tracking-[0.02em] text-[#d89b22]">
                {locale === 'az' ? cmsText("xeberler/[slug]/news-detail-client.037") : cmsText("xeberler/[slug]/news-detail-client.038")}
              </span>
              ...
              >
                {cmsText("xeberler/[slug]/news-detail-client.040")}</h1>
              ...
              <div className="mt-8 flex items-center gap-3 text-[0.98rem] text-[#374151]">
                ...
                <span>{locale === 'az' ? cmsText("xeberler/[slug]/news-detail-client.041") : cmsText("xeberler/[slug]/news-detail-client.042")}</span>
              </div>
            </div>

            <div className="order-1 relative overflow-hidden rounded-[18px] shadow-[0_28px_80px_rgba(6,11,19,0.18)] lg:order-2">
              <Image
                src={cmsText("xeberler/[slug]/news-detail-client.043")}
            ...
            <aside className="order-1 rounded-[18px] bg-[#faf8f4] p-6 shadow-[0_20px_50px_rgba(15,23,42,0.05)] ring-1 ring-[#f1ede5] sm:p-8 lg:order-2">
              <div className="flex flex-col gap-6 sm:gap-8 md:flex-row md:items-center md:justify-between md:gap-8">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-5">
                    <p className="text-[1rem] font-bold text-[#111827]">{cmsText("xeberler/[slug]/news-detail-client.044")}</p>
                    <p className="mt-1 text-[0.96rem] leading-7 text-[#4b5563]">
                      {locale === 'az' ? cmsText("xeberler/[slug]/news-detail-client.045") : cmsText("xeberler/[slug]/news-detail-client.046")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-center md:justify-end">
                  <div className="overflow-hidden rounded-full ring-2 ring-[#ece4d4]">
                    <Image
                      src={cmsText("xeberler/[slug]/news-detail-client.047")}
...
export function NewsDetailClient({ slug }: { slug: string }) {
  ...
  const allNews = useMemo(() => mergeNews(adminNews, locale, translateNewsArticle), [adminNews, locale, translateNewsArticle])
    ...
    return (
      <section className="bg-background px-4 py-24">
        <div className="mx-auto max-w-4xl rounded-[24px] bg-card p-10 text-center text-muted-foreground shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
          {locale === 'az' ? cmsText("xeberler/[slug]/news-detail-client.050") : cmsText("xeberler/[slug]/news-detail-client.051")}
        </div>
      </section>
    )
  }
    ...
    return (
      <section className="bg-background px-4 py-24">
        <div className="mx-auto max-w-3xl rounded-[24px] bg-card p-10 text-center shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
          <h1 className="text-3xl font-bold text-foreground">{locale === 'az' ? cmsText("xeberler/[slug]/news-detail-client.052") : cmsText("xeberler/[slug]/news-detail-client.053")}</h1>
          <p className="mt-4 text-muted-foreground">
            {locale === 'az'
              ? cmsText("xeberler/[slug]/news-detail-client.054")
              : cmsText("xeberler/[slug]/news-detail-client.055")}
          </p>
          <Link
            href={cmsText("xeberler/[slug]/news-detail-client.056")}
            className="mt-6 inline-flex rounded-full bg-[#060b13] px-6 py-3 text-sm font-semibold text-white"
          >
            {locale === 'az' ? cmsText("xeberler/[slug]/news-detail-client.057") : cmsText("xeberler/[slug]/news-detail-client.058")}
          </Link>
        </div>
      </section>
    )
